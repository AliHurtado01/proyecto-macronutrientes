...
2.  **Optimización de Rendimiento:**
    * Uso de columnas de "caché" en la tabla `dishes` (`total_calories`, etc.) que se actualizan solo al editar la receta, evitando lecturas masivas en tiempo de ejecución.
...
git clone [https://github.com/TU_USUARIO/nutritrack.git](https://github.com/TU_USUARIO/nutritrack.git)
